...
<%@page import="DDTA.IdGenerator"%>
<%@page import="stockverification.getIndicators"%>
<%@page import="java.util.logging.Logger"%>
<%@page import="java.util.logging.Level"%>
<%@page import="java.sql.SQLException"%>
<%@page import="org.json.simple.JSONArray"%>
<%@page import="Database.dbConn"%>
<%@page import="stockverification.getReportingDates"%>
...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Dumisha Stocks Receipt Verification</title>
        <meta name="generator" content="Bootply" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <link href="stock/css/dataTables.bootstrap.min.css" rel="stylesheet">
        <link href="stock/css/bootstrap.css" rel="stylesheet">
        <link href="stock/css/bootstrap-datepicker.min.css" rel="stylesheet">
        <link rel="stylesheet" href="stock/css/select2.min.css">
        <link rel="shortcut icon" href="stock/images/stocks_.png">
        ...
        <![endif]-->
        <link href="stock/css/styles.css" rel="stylesheet">
        <link href="stock/assets/css/metro.css" rel="stylesheet" />
...
<form action="commoditiesreported" id="reportingForm">
        ...
        <!-- script references -->
        <script src="stock/js/jquery-1.9.1.js"></script>
        <script src="stock/js/bootstrap.js"></script>
        <script src="stock/js/scripts.js"></script>
        <script src="stock/js/bootstrap-datepicker.min.js"></script>
        <script src="stock/js/select2.min.js"></script>
        <script src="stock/js/pouchdb-4.0.1.js"></script>
        <script type="text/javascript" src="stock/js/datatables.min.js"></script>
        <script type="text/javascript" src="stock/js/angular.js"></script>
        <script type="text/javascript" src="stock/js/angularoptions_htsself.js"></script>
        <script type="text/javascript" src="stock/gaps/sum_values.js"></script>
        <script type="text/javascript" src="stock/gaps/validation.js"></script>
