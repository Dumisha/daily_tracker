<%-- 
    Document   : commodity_report
    Created on : 9 Mar 2023, 15:00:57
    Author     : mwamb
--%>
...
<br>
            <div class="card">
              <div class="card-header">
                  <h3 class="card-title" style="text-align: center;font-weight: 900;">Commodity Report Generation Module</h3>
              </div>
                         <div class="card-body">        
                             <form action="stock_report">        
