<%-- 
    Document   : Indicator_Summary
    Created on : 5 Jun 2023, 08:39:13
    Author     : mwamb
--%>
...
<head>
  ...
  <title>Indicator Summary Data</title>
...
<br>
            <div class="card">
              <div class="card-header">
                  <h3 class="card-title" style="text-align: center;font-weight: 900;">Indicator Summary Generation Module</h3>
              </div>
                         <div class="card-body">        
                             <form action="ProgressSummary">        
                    ...
                    <div class="form-group has-feedback has-feedback-left flex-child" id="user_level">
                       ...
                       <button type="submit" id="submit" class="btn btn-primary btn-block">Generate Data</button>      
                         </div> 
