            ...
            <div class="card">
              <div class="card-header">
                  <h3 class="card-title" style="text-align: center;font-weight: 900;">User management module</h3>
                    ...
                    <div class="flex-container" id="program_area_label">
                     <div class="flex-child">
                    Program Areas:
                    </div>
                    <div class="form-group has-feedback has-feedback-left flex-child">
                        <select class="form-control select2bs4" id="program_area" name="program_area"  required="true" multiple="true"> </select>
                    </div>
                    </div>
                    ...
                    <div class="form-group has-feedback has-feedback-left flex-child" id="user_level">
                         <select class="form-control select2bs4" id="indicator" name="indicator"  required="true" multiple="true"> </select>
                    </div>
                    </div>                     
                       
                              <div class="flex-container" id="indicator_label">
                       <button type="submit" id="submit" class="btn btn-primary btn-block">Generate Report</button>      
                         </div> 
