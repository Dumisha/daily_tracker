...
public class commoditiesreported extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String createdOn = mg.get_timestamp();
...
SXSSFWorkbook wb = new SXSSFWorkbook(wb1, 1000);
        ...
        stylex.setFillForegroundColor(HSSFColor.HSSFColorPredefined.GREY_40_PERCENT.getIndex());
        ...
        stylesum.setFillForegroundColor(HSSFColor.HSSFColorPredefined.GREY_40_PERCENT.getIndex());
        ...
        String enddate=mg.get_timestamp();
...
//                    
        ...
        String qry = "call sp_stocks_entered_data('"+startdate+"','"+enddate+"');";
