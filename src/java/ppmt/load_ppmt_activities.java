 ...
 */
public class load_ppmt_activities extends HttpServlet {
    HttpSession session;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        while(conn.rs.next()){
            ...
            obj.put("indicator_id", conn.rs.getInt(2));
            obj.put("name", conn.rs.getString(3));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(load_ppmt_activities.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
