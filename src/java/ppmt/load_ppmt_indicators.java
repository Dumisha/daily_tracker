 ...
 */
public class load_ppmt_indicators extends HttpServlet {
    HttpSession session;
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        while(conn.rs.next()){
            ...
            obj.put("number", conn.rs.getString(3));
            obj.put("status", conn.rs.getInt(4));
            
          jarray.add(obj);
        }
           }
           else{ // do not have enough permissions to view this page
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(load_ppmt_indicators.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
