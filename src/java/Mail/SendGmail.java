...
public class SendGmail {
    String smtpAddress = "mail.usaiddumishaafya.or.ke"; 
    String smtpPort = "587";
    String enableTLS = "true" ;
    String enableAuth = "true" ;
    final String username = "gnyabuto@usaiddumishaafya.or.ke" ;
    final String password = "@Nokia1203";
...
public void sendEmail(
    ...
    try {
        ...
        msg.setSubject("USAID Dumisha Afya Authentication");
